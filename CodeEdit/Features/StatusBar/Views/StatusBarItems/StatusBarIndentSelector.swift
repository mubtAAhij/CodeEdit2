...
struct StatusBarIndentSelector: View {
    ...
    var body: some View {
        Menu {
            ...
            Picker(String(localized: "status-bar.indent.tab-width-label", defaultValue: "Tab Width", comment: "Label for tab width picker"), selection: $defaultTabWidth) {
            ...
            Text(String(format: String(localized: "status-bar.indent.current-width", defaultValue: "%d Spaces", comment: "Current tab width in spaces"), defaultTabWidth))
        }
