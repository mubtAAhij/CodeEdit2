...
struct StatusBarIndentSelector: View {
    ...
    var body: some View {
        Menu {
            ...
            Text(String(format: String(localized: "status-bar.indent.current-width", defaultValue: "%d Spaces", comment: "Status bar label showing current tab width in spaces"), defaultTabWidth))
        }
