    ...
    struct LineLabel: View {
        ...
        func getLabel() -> String {
            ...
            if cursorPositions[0].range.length > 0 {
                ...
                if lineCount > 1 {
                    return String(format: String(localized: "status-bar.cursor.lines", defaultValue: "%d lines", comment: "Number of selected lines"), lineCount)
                }

                return String(format: String(localized: "status-bar.cursor.characters", defaultValue: "%ld characters", comment: "Number of selected characters"), cursorPositions[0].range.length)
            }
