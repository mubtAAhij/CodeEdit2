...
struct StatusBarCursorPositionLabel: View {
    ...
    struct LineLabel: View {
        ...
        func getLabel() -> String {
            ...
            if modifierKeys.contains(.option) {
                return String(format: String(localized: "status-bar.cursor.char-len-zero", defaultValue: "Char: %d Len: 0", comment: "Character position with zero length"), cursorPositions[0].range.location)
            }
