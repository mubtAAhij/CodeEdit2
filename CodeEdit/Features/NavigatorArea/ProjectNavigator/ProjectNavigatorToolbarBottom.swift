...
struct ProjectNavigatorToolbarBottom: View {
    ...
    var body: some View {
        HStack(spacing: 5) {
            addNewFileButton
            PaneTextField(
                String(localized: "project-navigator.filter", defaultValue: "Filter", comment: "Placeholder for filter text field in project navigator"),
    ...
    private var addNewFileButton: some View {
            ...
            Button(String(localized: "project-navigator.add-folder", defaultValue: "Add Folder", comment: "Menu item to add a new folder")) {
                ...
                do {
                    if let newFolder = try workspace.workspaceFileManager?.addFolder(
                        folderName: String(localized: "project-navigator.untitled-folder", defaultValue: "untitled", comment: "Default name for new untitled folder"),
                        toFile: rootFile
                    ) {
        ...
        .accessibilityLabel(String(localized: "project-navigator.add-label", defaultValue: "Add Folder or File", comment: "Accessibility label for add button"))
