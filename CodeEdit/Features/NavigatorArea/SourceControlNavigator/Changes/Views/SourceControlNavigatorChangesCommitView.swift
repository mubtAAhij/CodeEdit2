            ...
            VStack(spacing: 0) {
                ...
                .safeAreaInset(edge: .bottom, spacing: 0) {
                    if showDetails {
                        VStack {
                            TextField(
                                String(localized: "source-control.detailed-description-placeholder", defaultValue: "Detailed description", comment: "Placeholder text for detailed description field"),
                                text: $details,
                                axis: .vertical
                            )
                ...
                VStack(spacing: 0) {
                    if showDetails {
                        Toggle(isOn: $ammend) {
                            Text(String(localized: "source-control.amend-toggle", defaultValue: "Amend", comment: "Toggle label to amend previous commit"))
                ...
                HStack(spacing: 8) {
                    ...
                    Menu(isCommiting ? String(localized: "source-control.committing", defaultValue: "Committing...", comment: "Menu label shown while commit is in progress") : String(localized: "source-control.commit-button", defaultValue: "Commit", comment: "Button to commit changes")) {
