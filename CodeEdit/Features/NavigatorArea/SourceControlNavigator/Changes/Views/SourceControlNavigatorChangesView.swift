    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if hasChanges {
                ...
                CEContentUnavailableView(String(localized: "source-control-navigator.no-changes", defaultValue: "No Changes", comment: "Message when there are no source control changes"))
            }
        }
