    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if hasChanges {
                ...
                CEContentUnavailableView(String(localized: "source_control.changes.empty_state", defaultValue: "No Changes", comment: "Message shown when there are no source control changes"))
            }
        }
