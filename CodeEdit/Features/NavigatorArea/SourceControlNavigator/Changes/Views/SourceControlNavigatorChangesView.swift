    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if hasChanges {
                ...
                CEContentUnavailableView(String(localized: "source-control.no-changes", defaultValue: "No Changes", comment: "Empty state message when there are no source control changes"))
            }
        }
