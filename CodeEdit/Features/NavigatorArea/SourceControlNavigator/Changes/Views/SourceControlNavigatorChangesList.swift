                ...
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    Group {
                        ...
                        Button(String(localized: "source-control.reveal-in-project-navigator", defaultValue: "Reveal in Project Navigator", comment: "Menu item to reveal file in project navigator")) {}
                    ...
                    if file.anyStatus() != .none {
                        Group {
                            Divider()
                            Button(String(format: String(localized: "source-control.discard-changes", defaultValue: "Discard Changes in %@...", comment: "Menu item to discard changes in a file"), file.fileURL.lastPathComponent)) {
