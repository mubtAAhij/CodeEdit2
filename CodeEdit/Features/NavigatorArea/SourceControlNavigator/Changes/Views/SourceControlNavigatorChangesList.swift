            ...
            menu: { selectedFiles in
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    Group {
                        Button(String(localized: "source-control.view-in-finder", defaultValue: "View in Finder", comment: "Context menu option to view file in Finder")) {
                    ...
                    if file.anyStatus() != .none {
                        Group {
                            Divider()
                            Button(String(format: String(localized: "source-control.discard-changes", defaultValue: "Discard Changes in %@...", comment: "Context menu option to discard changes in a file"), file.fileURL.lastPathComponent)) {
