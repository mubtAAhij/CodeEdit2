        ...
        Group {
            if shouldShow {
                HStack(alignment: .center) {
                    ...
                    .help(String(localized: "find-navigator.indexing.help", defaultValue: "Indexing current workspace files for search. Searches performed while indexing may return incomplete results.", comment: "Help text explaining indexing behavior"))
                }
