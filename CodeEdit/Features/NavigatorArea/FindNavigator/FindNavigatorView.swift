    ...
    var body: some View {
        VStack {
            ...
            case .replaced(let updatedFiles):
                CEContentUnavailableView(
                    String(localized: "find_navigator.replaced", defaultValue: "Replaced", comment: "Title when replacement completed"),
            ...
            case .failed(let errorMessage):
                CEContentUnavailableView(
                    String(localized: "find_navigator.error_occurred", defaultValue: "An Error Occurred", comment: "Title when search/replace error occurs"),
