        ...
        VStack {
            ...
            case .searching:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.searching", defaultValue: "Searching", comment: "Status message during search"))
            ...
            case .replacing:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.replacing", defaultValue: "Replacing", comment: "Status message during replace operation"))
                        .foregroundStyle(.tertiary)
                        .font(.title3)
                }
                .frame(maxHeight: .infinity)
