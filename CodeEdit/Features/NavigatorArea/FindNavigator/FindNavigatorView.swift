        ...
        VStack {
            ...
            if findNavigatorStatus == .found {
                HStack(alignment: .center) {
                    Text(String(format: String(localized: "find_navigator.results_summary", defaultValue: "%#@results@ in %#@files@", comment: "Summary of search results showing count of results and files"), self.searchResultCount, self.foundFilesCount))
                        .font(.system(size: 10))
                }
            ...
            case .searching:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.status.searching", defaultValue: "Searching", comment: "Status message during search"))
            ...
            case .replacing:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.status.replacing", defaultValue: "Replacing", comment: "Status message during replace operation"))
                        .foregroundStyle(.tertiary)
                        .font(.title3)
                }
                .frame(maxHeight: .infinity)
            ...
            case .replaced(let updatedFiles):
                CEContentUnavailableView(
                    String(localized: "find_navigator.replaced", defaultValue: "Replaced", comment: "Title when replace operation completes"),
            ...
            case .failed(let errorMessage):
                CEContentUnavailableView(
                    String(localized: "find_navigator.error_occurred", defaultValue: "An Error Occurred", comment: "Title when an error occurs during search or replace"),
