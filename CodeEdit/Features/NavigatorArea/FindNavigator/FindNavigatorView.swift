        ...
        VStack {
            ...
            if findNavigatorStatus == .found {
                HStack(alignment: .center) {
                    Text(String(format: String(localized: "find_navigator.results_summary", defaultValue: "%#@results@ in %#@files@", comment: "Summary of search results found"), searchResultCount, foundFilesCount))
                        .font(.system(size: 10))
                }
            ...
            case .searching:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.searching", defaultValue: "Searching", comment: "Searching progress indicator"))
            ...
            case .replacing:
                VStack {
                    ...
                    Text(String(localized: "find-navigator.replacing", defaultValue: "Replacing", comment: "Replacing progress indicator"))
                        .foregroundStyle(.tertiary)
                        .font(.title3)
                }
                .frame(maxHeight: .infinity)
            case .found:
                if self.searchResultCount == 0 {
                    CEContentUnavailableView(
                        String(localized: "find_navigator.no_results", defaultValue: "No Results", comment: "Empty state title when no search results found"),
            ...
            case .replaced(let updatedFiles):
                CEContentUnavailableView(
                    String(localized: "find_navigator.replaced", defaultValue: "Replaced", comment: "Success title after replacing terms"),
