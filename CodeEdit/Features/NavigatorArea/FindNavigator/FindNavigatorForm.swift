    ...
    var body: some View {
        VStack {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.with", defaultValue: "With", comment: "Placeholder for replace text field"),
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find_navigator.only_in_folders", defaultValue: "Only in folders", comment: "Placeholder for include folders text field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-only-in-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for search in open editors toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find_navigator.excluding_folders", defaultValue: "Excluding folders", comment: "Placeholder for exclude folders text field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
