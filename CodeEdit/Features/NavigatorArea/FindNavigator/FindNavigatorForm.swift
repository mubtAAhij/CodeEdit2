    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped", defaultValue: "Scoped", comment: "Toggle button to enable scoped search"))
                    .controlSize(.small)
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.replace-with", defaultValue: "With", comment: "Label for replacement text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.preserve-case-label", defaultValue: "AB", comment: "Icon label for preserve case toggle"))
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find_navigator.only_in_folders", defaultValue: "Only in folders", comment: "Label for folder inclusion field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for open editors search toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find_navigator.excluding_folders", defaultValue: "Excluding folders", comment: "Label for folder exclusion field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
