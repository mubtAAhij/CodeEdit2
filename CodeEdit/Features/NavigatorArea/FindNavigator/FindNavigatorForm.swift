        ...
        VStack {
            ...
            if scoped {
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.exclude-settings-tooltip", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Tooltip for use exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.replace-all-button", defaultValue: "Replace All", comment: "Button to replace all search results"))
