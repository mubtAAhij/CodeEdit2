    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped-label", defaultValue: "Scoped", comment: "Label for scoped search toggle button"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.match-case-help", defaultValue: "Match Case", comment: "Tooltip for case-sensitive search toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.with-placeholder", defaultValue: "With", comment: "Placeholder for replacement text field"),
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.open-editors-help", defaultValue: "Search only in Open Editors", comment: "Tooltip for open editors only search toggle"))
                    },
                    clearable: true,
