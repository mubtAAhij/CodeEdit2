    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.form.scoped-toggle", defaultValue: "Scoped", comment: "Toggle to enable scoped search"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.form.match-case-help", defaultValue: "Match Case", comment: "Help text for match case toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.form.replace-with-placeholder", defaultValue: "With", comment: "Placeholder for replace text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.form.preserve-case-label", defaultValue: "AB", comment: "Label for preserve case toggle"))
                        ...
                        .help(String(localized: "find-navigator.form.preserve-case-help", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.form.include-folders-placeholder", defaultValue: "Only in folders", comment: "Placeholder for folders to include in search"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.open-editors-help", defaultValue: "Search only in Open Editors", comment: "Help text for open editors toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.form.exclude-folders-placeholder", defaultValue: "Excluding folders", comment: "Placeholder for folders to exclude from search"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.exclude-settings-help", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.form.replace-all-button", defaultValue: "Replace All", comment: "Button to replace all occurrences"))
