        ...
        VStack {
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.ab-label", defaultValue: "AB", comment: "Label for preserve case toggle"))
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-only-in-open-editors", defaultValue: "Search only in Open Editors", comment: "Help text for search in open editors toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.replace-all", defaultValue: "Replace All", comment: "Button text to replace all occurrences"))
