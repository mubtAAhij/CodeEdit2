    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped", defaultValue: "Scoped", comment: "Toggle to scope search"))
                    .controlSize(.small)
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for search in open editors toggle"))
                    },
                    clearable: true,
