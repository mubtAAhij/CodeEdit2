    ...
    var body: some View {
        VStack {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator-form.with", defaultValue: "With", comment: "Placeholder for replacement text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator-form.ab-label", defaultValue: "AB", comment: "Label for preserve case toggle button"))
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator-form.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for search in open editors toggle"))
                    },
                    clearable: true,
