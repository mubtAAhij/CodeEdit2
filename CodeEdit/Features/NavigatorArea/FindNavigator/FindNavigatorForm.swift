    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator-form.scoped", defaultValue: "Scoped", comment: "Label for scoped search option"))
                    .controlSize(.small)
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator-form.with", defaultValue: "With", comment: "Placeholder for replace text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator-form.preserve-case-icon", defaultValue: "AB", comment: "Icon label for preserve case toggle"))
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator-form.search-only-in-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for search in open editors toggle"))
                    },
                    clearable: true,
