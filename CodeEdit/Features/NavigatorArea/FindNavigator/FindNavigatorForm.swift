    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.form.scoped", defaultValue: "Scoped", comment: "Toggle label for scoped search"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.form.match-case", defaultValue: "Match Case", comment: "Help text for match case toggle"))
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.form.preserve-case-icon", defaultValue: "AB", comment: "Icon text for preserve case toggle"))
                        ...
                        .help(String(localized: "find-navigator.form.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.open-editors", defaultValue: "Search only in Open Editors", comment: "Help text for open editors toggle"))
                    },
                    clearable: true,
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.form.replace-all", defaultValue: "Replace All", comment: "Button label for replace all action"))
