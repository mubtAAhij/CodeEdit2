    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator-form.scoped", defaultValue: "Scoped", comment: "Label for scoped search toggle"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator-form.match-case", defaultValue: "Match Case", comment: "Tooltip for match case toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator-form.with", defaultValue: "With", comment: "Label for replacement text field"),
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator-form.preserve-case", defaultValue: "Preserve Case", comment: "Tooltip for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator-form.only-in-folders", defaultValue: "Only in folders", comment: "Label for include folders field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator-form.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Tooltip for open editors only toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator-form.excluding-folders", defaultValue: "Excluding folders", comment: "Label for exclude folders field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator-form.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Tooltip for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator-form.replace-all", defaultValue: "Replace All", comment: "Button to replace all occurrences"))
