        ...
        VStack {
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.match-case", defaultValue: "Match Case", comment: "Match case toggle help text"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.preserve-case", defaultValue: "Preserve Case", comment: "Preserve case toggle help text"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find_navigator.only_in_folders", defaultValue: "Only in folders", comment: "Folder inclusion field placeholder"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Open editors toggle help text"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find_navigator.excluding_folders", defaultValue: "Excluding folders", comment: "Folder exclusion field placeholder"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Exclude settings toggle help text"))
                    },
                    clearable: true,
