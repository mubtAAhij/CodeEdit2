...
struct TasksCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.tasks", defaultValue: "Tasks", comment: "Tasks menu title")) {
            ...
            Button(String(format: String(localized: "menu.tasks.run", defaultValue: "Run %@", comment: "Menu item to run selected task"), selectedTaskName), systemImage: "play.fill") {
            ...
            Button(String(format: String(localized: "menu.tasks.stop", defaultValue: "Stop %@", comment: "Menu item to stop selected task"), selectedTaskName), systemImage: "stop.fill") {
            ...
            Menu {
                ...
                Text(String(localized: "menu.tasks.choose-task", defaultValue: "Choose Task...", comment: "Menu to choose a task"))
            }
