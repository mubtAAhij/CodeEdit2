    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.editor", defaultValue: "Editor", comment: "Editor menu title")) {
            Menu(String(localized: "menu.editor.structure", defaultValue: "Structure", comment: "Structure submenu title")) {
                Button(String(localized: "menu.editor.structure.move-line-up", defaultValue: "Move line up", comment: "Move line up menu item")) {
                    editor?.selectedTab?.rangeTranslator.moveLinesUp()
                }
                .keyboardShortcut("[", modifiers: [.command, .option])

                Button(String(localized: "menu.editor.structure.move-line-down", defaultValue: "Move line down", comment: "Move line down menu item")) {
