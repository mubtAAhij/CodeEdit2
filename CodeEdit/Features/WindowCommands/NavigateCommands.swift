    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.navigate", defaultValue: "Navigate", comment: "Navigate menu title")) {
            Group {
                ...
                Button(String(localized: "menu.navigate.open-in-next-editor", defaultValue: "Open in Next Editor", comment: "Menu item to open file in next editor")) {

                }
                .keyboardShortcut(",", modifiers: [.option, .command])
                .disabled(true)

                Button(String(localized: "menu.navigate.open-in-ellipsis", defaultValue: "Open in...", comment: "Menu item to open file in specific editor")) {
