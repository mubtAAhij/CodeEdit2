...
struct WindowCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .singleWindowList) {
            Button(String(localized: "menu.welcome-to-codeedit", defaultValue: "Welcome to CodeEdit", comment: "Welcome window menu item")) {
            ...
            Button(String(localized: "menu.manage-extensions", defaultValue: "Manage Extensions", comment: "Menu item to manage extensions")) {
