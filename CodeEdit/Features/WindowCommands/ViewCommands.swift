...
struct ViewCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(after: .toolbar) {
            ...
            Menu(String(localized: "view-commands.font-size", defaultValue: "Font Size", comment: "Menu for font size options")) {
...
extension ViewCommands {
    struct NavigatorCommands: View {
        ...
        var body: some View {
            Menu(String(localized: "view-commands.navigators", defaultValue: "Navigators", comment: "Menu for navigator options"), content: {
