...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file-commands.new", defaultValue: "New", comment: "Button to create new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file-commands.open", defaultValue: "Open...", comment: "Button to open file")) {
                ...
                Menu(String(localized: "file-commands.open-recent", defaultValue: "Open Recent", comment: "Menu for opening recent files")) { }

                Button(String(localized: "file-commands.open-quickly", defaultValue: "Open Quickly", comment: "Button to open quick open panel")) {
