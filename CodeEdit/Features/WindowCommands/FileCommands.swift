...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "menu.file.new", defaultValue: "New", comment: "Menu item to create new document")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "menu.file.open", defaultValue: "Open...", comment: "Menu item to open document")) {
                ...
                Menu(String(localized: "menu.file.open-recent", defaultValue: "Open Recent", comment: "Menu item to open recent projects")) { }
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "menu.file.close-editor", defaultValue: "Close Editor", comment: "Menu item to close current editor")) {
            ...
            Button(String(localized: "menu.file.close-window", defaultValue: "Close Window", comment: "Menu item to close current window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "menu.file.close-workspace", defaultValue: "Close Workspace", comment: "Menu item to close current workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
