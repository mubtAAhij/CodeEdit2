...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file-commands.new", defaultValue: "New", comment: "Button to create new document")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file-commands.open", defaultValue: "Open...", comment: "Button to open document")) {
                ...
                Menu(String(localized: "file-commands.open-recent", defaultValue: "Open Recent", comment: "Menu for recent projects")) { }

                Button(String(localized: "file-commands.open-quickly", defaultValue: "Open Quickly", comment: "Button to open quick file picker")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file-commands.close-tab", defaultValue: "Close Tab", comment: "Button to close current tab")) {
            ...
            Button(String(localized: "file-commands.close-editor", defaultValue: "Close Editor", comment: "Button to close current editor")) {
            ...
            Button(String(localized: "file-commands.close-window", defaultValue: "Close Window", comment: "Button to close current window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file-commands.close-workspace", defaultValue: "Close Workspace", comment: "Button to close current workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file-commands.close-terminal", defaultValue: "Close Terminal", comment: "Button to close terminal")) {
            ...
            Button(String(localized: "file-commands.workspace-settings", defaultValue: "Workspace Settings", comment: "Button to open workspace settings")) {
            ...
            Button(String(localized: "file-commands.save", defaultValue: "Save", comment: "Button to save document")) {
