...
struct LocalizationFeatureTestPage: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Group {
                TextField(String(localized: "localization-test.username-field", defaultValue: "Username", comment: "Username field placeholder"), text: $username)
                TextField(String(localized: "localization-test.email-field", defaultValue: "Email Address", comment: "Email address field placeholder"), text: $email)
            ...
            Text(String(localized: "localization-test.backup-success", defaultValue: "Last backup completed successfully", comment: "Backup completion status message"))
            ...
            HStack {
                ...
                Text(String(localized: "localization-test.quick-tip-content", defaultValue: "Press Command+Shift+P to open the command palette.", comment: "Tip about opening command palette"))
            }

            Text(String(localized: "localization-test.delete-label", defaultValue: "Delete", comment: "Delete button label"))
                .foregroundStyle(.red)
