...
struct LocalizationFeatureTestPage: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(String(localized: "localization-test.backup-success", defaultValue: "Last backup completed successfully", comment: "Backup completion status"))
            ...
            HStack {
                Text(String(localized: "localization-test.tip-prefix", defaultValue: "Quick tip:", comment: "Quick tip label prefix"))
            ...
            Text(String(localized: "localization-test.delete-action", defaultValue: "Delete", comment: "Delete action label"))
                .foregroundStyle(.red)
            Text(String(localized: "localization-test.delete-confirmation", defaultValue: "Are you sure you want to permanently remove this workspace?", comment: "Workspace deletion confirmation prompt"))
        }
        .padding()
    }
}
