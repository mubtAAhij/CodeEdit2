    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                Text(String(localized: "localization-test.command-palette-tip", defaultValue: "Press Command+Shift+P to open the command palette.", comment: "Tip about command palette shortcut"))
            }

            Text(String(localized: "localization-test.delete-button", defaultValue: "Delete", comment: "Delete action button label"))
                .foregroundStyle(.red)
