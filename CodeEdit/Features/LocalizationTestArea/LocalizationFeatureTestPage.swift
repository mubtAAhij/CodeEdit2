...
struct LocalizationFeatureTestPage: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(String(localized: "localization-test.sync-status", defaultValue: "Sync status: Connected", comment: "Synchronization status message"))
            Text(String(localized: "localization-test.backup-complete", defaultValue: "Last backup completed successfully", comment: "Backup completion confirmation message"))
            Text(String(format: String(localized: "localization-test.recent-projects", defaultValue: "Found %d recent projects", comment: "Number of recent projects found"), projectCount))
            Text(String(localized: "localization-test.updates-available", defaultValue: "New updates are available", comment: "Updates availability notification"))
