...
struct LocalizationFeatureTestPage: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Group {
                TextField(String(localized: "localization-test.username-field", defaultValue: "Username", comment: "Username text field label"), text: $username)
                TextField(String(localized: "localization-test.email-field", defaultValue: "Email Address", comment: "Email address text field label"), text: $email)
            ...
            Text(String(format: String(localized: "localization-test.projects-found", defaultValue: "Found %d recent projects", comment: "Number of recent projects found"), projectCount))
            Text(String(localized: "localization-test.updates-available", defaultValue: "New updates are available", comment: "Message when new updates are available"))
            Text(String(localized: "localization-test.extension-error", defaultValue: "Failed to load extensions. Please try again.", comment: "Error message when extensions fail to load"))

            HStack {
                Text(String(localized: "localization-test.tip-label", defaultValue: "Quick tip:", comment: "Label for tip section"))
