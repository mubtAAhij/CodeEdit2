...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(format: String(localized: "file-manager.delete-confirmation-title", defaultValue: "Do you want to delete \"%@\"?", comment: "Alert title asking to confirm deleting a file"), fileName)
        deleteConfirmation.informativeText = String(localized: "file-manager.delete-confirmation-message", defaultValue: "This item will be deleted immediately. You can't undo this action.", comment: "Alert message explaining delete is permanent")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "file-manager.delete-button", defaultValue: "Delete", comment: "Button to confirm file deletion"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "file-manager.cancel-button", defaultValue: "Cancel", comment: "Button to cancel file deletion"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(format: String(localized: "file-manager.batch-delete-confirmation-title", defaultValue: "Are you sure you want to delete the %d selected items?", comment: "Alert title asking to confirm deleting multiple files"), files.count)
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(format: String(localized: "file-manager.batch-delete-confirmation-message", defaultValue: "%d items will be deleted immediately. You cannot undo this action.", comment: "Alert message explaining multiple deletes are permanent"), files.count)
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "file-manager.delete-button", defaultValue: "Delete", comment: "Button to confirm file deletion"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "file-manager.cancel-button", defaultValue: "Cancel", comment: "Button to cancel file deletion"))
