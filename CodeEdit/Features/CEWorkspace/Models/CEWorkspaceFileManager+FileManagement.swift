...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(format: String(localized: "file_management.delete.confirmation_message", defaultValue: "Do you want to delete \"%@\"?", comment: "Confirmation message for deleting a file"), fileName)
        deleteConfirmation.informativeText = String(localized: "file_management.delete.warning_message", defaultValue: "This item will be deleted immediately. You can't undo this action.", comment: "Warning that delete action is irreversible")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "file-management.delete-button", defaultValue: "Delete", comment: "Button to confirm deletion"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "file-management.cancel-button", defaultValue: "Cancel", comment: "Button to cancel deletion"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.informativeText = String(format: String(localized: "file_management.batch_delete.warning_message", defaultValue: "%d items will be deleted immediately. You cannot undo this action.", comment: "Warning that batch delete action is irreversible"), files.count)
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "file-management.batch-delete-button", defaultValue: "Delete", comment: "Button to confirm batch deletion"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "file-management.batch-cancel-button", defaultValue: "Cancel", comment: "Button to cancel batch deletion"))
    ...
    public func duplicate(file: CEWorkspaceFile) throws {
        ...
        while fileManager.fileExists(atPath: fileUrl.path) {
            ...
            fileUrl = fileUrl.deletingLastPathComponent().appending(path: String(format: String(localized: "file_management.duplicate.copy_suffix", defaultValue: "%@ copy%@", comment: "Filename format for duplicated file"), fileName, fileExtension))
        }
