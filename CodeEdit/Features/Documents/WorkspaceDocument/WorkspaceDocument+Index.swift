...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            ...
            "action": "create",
            "title": String(
                localized: "workspace-document.indexing.processing-files",
                defaultValue: "Indexing | Processing files",
                comment: "Title shown when indexing workspace files"
            ),
            "message": String(
                localized: "workspace-document.indexing.create-index-message",
                defaultValue: "Creating an index to enable fast and accurate searches within your codebase.",
                comment: "Message explaining the indexing process"
            ),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                ...
                "action": "update",
                "title": String(
                    localized: "workspace-document.indexing.finished",
                    defaultValue: "Finished indexing",
                    comment: "Title shown when indexing is complete"
                ),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
