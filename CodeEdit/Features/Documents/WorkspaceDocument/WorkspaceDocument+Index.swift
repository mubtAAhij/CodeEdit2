...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace_document.indexing.processing_files", defaultValue: "Indexing | Processing files", comment: "Notification title when indexing workspace files"),
            "message": String(localized: "workspace_document.indexing.create_index_message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Notification message explaining indexing purpose"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "workspace_document.indexing.finished", defaultValue: "Finished indexing", comment: "Notification title when indexing is complete"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
