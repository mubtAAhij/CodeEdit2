...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            ...
            "message": String(localized: "workspace_document.indexing.create_index_message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message explaining index creation purpose"),
            "isLoading": true
        ]
