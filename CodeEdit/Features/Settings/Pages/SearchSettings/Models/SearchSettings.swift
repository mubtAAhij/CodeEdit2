...
extension SettingsData {
    struct SearchSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.search.ignore-glob-patterns", defaultValue: "Ignore Glob Patterns", comment: "Title for ignore glob patterns setting"),
                String(localized: "settings.search.ignore-patterns", defaultValue: "Ignore Patterns", comment: "Title for ignore patterns setting")
            ]
        }
