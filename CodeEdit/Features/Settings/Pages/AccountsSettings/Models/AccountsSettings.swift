...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.accounts.search-key-accounts", defaultValue: "Accounts", comment: "Search key for accounts settings"),
                String(localized: "settings.accounts.search-key-delete", defaultValue: "Delete Account...", comment: "Search key for delete account action"),
                String(localized: "settings.accounts.search-key-add", defaultValue: "Add Account...", comment: "Search key for add account action")
            ]
        }
