...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "terminal.settings.shell", defaultValue: "Shell", comment: "Terminal settings search key for shell option"),
                String(localized: "terminal.settings.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Terminal settings search key for Option key as Meta option"),
                String(localized: "terminal.settings.use-text-editor-font", defaultValue: "Use text editor font", comment: "Terminal settings search key for use text editor font option"),
                String(localized: "terminal.settings.font", defaultValue: "Font", comment: "Terminal settings search key for font option"),
                String(localized: "terminal.settings.font-size", defaultValue: "Font Size", comment: "Terminal settings search key for font size option"),
                String(localized: "terminal.settings.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal settings search key for cursor style option"),
                String(localized: "terminal.settings.blink-cursor", defaultValue: "Blink Cursor", comment: "Terminal settings search key for blink cursor option")
            ]
        }
