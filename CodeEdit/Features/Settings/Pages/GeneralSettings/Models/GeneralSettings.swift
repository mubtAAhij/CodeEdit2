...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "general-settings.search.dim-editors", defaultValue: "Dim editors without focus", comment: "Search key for dim editors setting"),
                ...
                String(localized: "general-settings.search.auto-save", defaultValue: "Automatically save change to disk", comment: "Search key for auto save setting"),
                String(localized: "general-settings.search.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto reveal setting"),
                ...
                String(localized: "general-settings.search.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open with CodeEdit setting"),
                String(localized: "general-settings.search.shell-command", defaultValue: "'codeedit' Shell command", comment: "Search key for shell command setting"),
                ...
                String(localized: "general-settings.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for auto check updates setting"),
                String(localized: "general-settings.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general-settings.navigator-detail.one-line", defaultValue: "One Line", comment: "Navigator detail one line option")
            default:
                return String(format: String(localized: "general-settings.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Navigator detail up to N lines option"), self.rawValue)
            }
        }
    }
}
