...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search.check-for-updates", defaultValue: "Check for updates", comment: "Search key for update checker setting"),
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general_settings.preview_lines.one_line", defaultValue: "One Line", comment: "Navigator detail option for one line preview")
            default:
                return String(format: String(localized: "general_settings.preview_lines.up_to_n_lines", defaultValue: "Up to %d lines", comment: "Navigator detail option for multiple line preview"), self.rawValue)
            }
        }
    }
}
