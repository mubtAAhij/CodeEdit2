...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "general_settings.search.tab_bar_style", defaultValue: "Tab Bar Style", comment: "Search key for Tab Bar Style setting"),
                ...
                String(localized: "settings.general.search.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Search key for Dim editors without focus setting"),
                ...
                String(localized: "general_settings.search.automatically_save_change_to_disk", defaultValue: "Automatically save change to disk", comment: "Search key for auto save setting"),
                ...
                String(localized: "general_settings.search.show_open_with_codeedit_option_in_finder", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for Open With CodeEdit setting"),
                String(localized: "general_settings.search.codeedit_shell_command", defaultValue: "'codeedit' Shell command", comment: "Search key for shell command setting"),
                ...
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for auto check updates setting"),
                String(localized: "settings.general.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search key for prerelease versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general_settings.preview_lines.one_line", defaultValue: "One Line", comment: "Navigator detail for one line preview")
            default:
                return String(format: String(localized: "general_settings.preview_lines.up_to_n_lines", defaultValue: "Up to %d lines", comment: "Navigator detail for multiple lines preview"), self.rawValue)
            }
        }
    }
}
