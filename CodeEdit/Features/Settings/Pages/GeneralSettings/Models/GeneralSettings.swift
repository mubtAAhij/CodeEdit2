...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "general-settings.search.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Search keyword for show jump bar setting"),
                String(localized: "general-settings.search.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Search keyword for dim editors setting"),
                ...
                String(localized: "general_settings.search.automatically_save_change_to_disk", defaultValue: "Automatically save change to disk", comment: "Search keyword for auto save setting"),
                String(localized: "general-settings.search.automatically-reveal-in-project-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Search keyword for auto reveal setting"),
                ...
                String(localized: "general-settings.search.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Search keyword for after last window closed setting"),
                ...
                String(localized: "general_settings.search.show_open_with_codeedit_option_in_finder", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search keyword for open with CodeEdit option"),
                String(localized: "general_settings.search.codeedit_shell_command", defaultValue: "'codeedit' Shell command", comment: "Search keyword for shell command setting"),
                ...
                String(localized: "general-settings.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search keyword for auto check updates setting"),
                String(localized: "general-settings.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search keyword for include prerelease setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general_settings.preview_lines.one_line", defaultValue: "One Line", comment: "Navigator detail setting for one line")
            default:
                return String(format: String(localized: "general_settings.preview_lines.up_to_n_lines", defaultValue: "Up to %d lines", comment: "Navigator detail setting for multiple lines"), self.rawValue)
            }
        }
    }
}
