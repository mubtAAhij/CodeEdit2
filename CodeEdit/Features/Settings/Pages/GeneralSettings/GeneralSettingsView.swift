...
private extension GeneralSettingsView {
    var appearance: some View {
        Picker(String(localized: "general-settings.appearance", defaultValue: "Appearance", comment: "Label for appearance setting"), selection: $settings.appAppearance) {
    ...
    var showIssues: some View {
        Picker(String(localized: "general-settings.show-issues", defaultValue: "Show Issues", comment: "Label for show issues setting"), selection: $settings.showIssues) {
    ...
    var showLiveIssues: some View {
        Toggle(String(localized: "general-settings.show-live-issues", defaultValue: "Show Live Issues", comment: "Label for show live issues toggle"), isOn: $settings.showLiveIssues)
    }

    var showEditorJumpBar: some View {
        Toggle(String(localized: "general-settings.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Label for show jump bar toggle"), isOn: $settings.showEditorJumpBar)
    }

    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "general-settings.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Label for dim editors toggle"), isOn: $settings.dimEditorsWithoutFocus)
    }

    var fileExtensions: some View {
        Group {
            Picker(String(localized: "general-settings.file-extensions", defaultValue: "File Extensions", comment: "Label for file extensions setting"), selection: $settings.fileExtensionsVisibility) {
    ...
    var fileIconStyle: some View {
        Picker(String(localized: "general-settings.file-icon-style", defaultValue: "File Icon Style", comment: "Label for file icon style setting"), selection: $settings.fileIconStyle) {
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "general-settings.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Label for navigator tab bar position setting"), selection: $settings.navigatorTabBarPosition) {
            Text(String(localized: "general-settings.tab-bar-position-top", defaultValue: "Top", comment: "Top tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "general-settings.tab-bar-position-side", defaultValue: "Side", comment: "Side tab bar position option"))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "general-settings.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Label for inspector tab bar position setting"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "general-settings.tab-bar-position-top", defaultValue: "Top", comment: "Top tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "general-settings.tab-bar-position-side", defaultValue: "Side", comment: "Side tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "general-settings.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Label for reopen behavior setting"), selection: $settings.reopenBehavior) {
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "general-settings.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Label for behavior after last window is closed"),
            selection: $settings.reopenWindowAfterClose
        ) {
            Text(String(localized: "general-settings.after-last-window-do-nothing", defaultValue: "Do nothing", comment: "Do nothing after last window closes"))
                .tag(SettingsData.ReopenWindowBehavior.doNothing)
            Divider()
            Text(String(localized: "general-settings.after-last-window-show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after last window closes"))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(localized: "general-settings.after-last-window-quit", defaultValue: "Quit", comment: "Quit app after last window closes"))
                .tag(SettingsData.ReopenWindowBehavior.quit)
        }
    }

    var projectNavigatorSize: some View {
        Picker(String(localized: "general-settings.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Label for project navigator size setting"), selection: $settings.projectNavigatorSize) {
    ...
    var findNavigatorDetail: some View {
        Picker(String(localized: "general-settings.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Label for find navigator detail setting"), selection: $settings.findNavigatorDetail) {
    ...
    var issueNavigatorDetail: some View {
        Picker(String(localized: "general-settings.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Label for issue navigator detail setting"), selection: $settings.issueNavigatorDetail) {
            ForEach(SettingsData.NavigatorDetail.allCases, id: \.self) { tag in
                Text(tag.label).tag(tag)
            }
        }
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "general-settings.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Label for dialog warnings setting")) {
            Button(action: {
            }, label: {
                Text(String(localized: "general-settings.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Button to reset don't ask me warnings"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "general-settings.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Label for codeedit shell command setting")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "general-settings.install", defaultValue: "Install", comment: "Button to install shell command"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "general-settings.check-now", defaultValue: "Check Now", comment: "Button to check for updates now")) {
                    updater.checkForUpdates()
                }
            } label: {
                Text(String(localized: "general-settings.check-for-updates", defaultValue: "Check for updates", comment: "Label for check for updates setting"))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "general-settings.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Toggle to automatically check for updates"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "general-settings.include-prerelease", defaultValue: "Include pre-release versions", comment: "Toggle to include pre-release versions"), isOn: $updater.includePrereleaseVersions)
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "general_settings.open_in_finder_toggle", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Toggle to show Open With CodeEdit in Finder"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "general_settings.reveal_in_navigator_toggle", defaultValue: "Automatically reveal in project navigator", comment: "Toggle to automatically reveal file in project navigator"), isOn: $settings.revealFileOnFocusChange)
    }
