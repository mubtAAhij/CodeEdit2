...
private extension GeneralSettingsView {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "general-settings.dim-editors", defaultValue: "Dim editors without focus", comment: "Toggle for dimming unfocused editors"), isOn: $settings.dimEditorsWithoutFocus)
    }
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "general-settings.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Label for shell command section")) {
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                Text(String(localized: "general-settings.updates.check-for-updates", defaultValue: "Check for updates", comment: "Label for update checker"))
                Text(String(format: String(localized: "general-settings.updates.last-checked", defaultValue: "Last checked: %@", comment: "Last update check time"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "general-settings.updates.auto-check", defaultValue: "Automatically check for app updates", comment: "Toggle for automatic update checking"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "general-settings.updates.include-prerelease", defaultValue: "Include pre-release versions", comment: "Toggle for including pre-release versions"), isOn: $updater.includePrereleaseVersions)
    }

    var autoSave: some View {
        Toggle(String(localized: "general-settings.auto-save", defaultValue: "Automatically save changes to disk", comment: "Toggle for automatic saving"), isOn: $settings.isAutoSaveOn)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "general-settings.updates.never", defaultValue: "Never", comment: "Never checked for updates")
        }
    }
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(
            String(
                localized: "general-settings.reveal-in-navigator-toggle",
