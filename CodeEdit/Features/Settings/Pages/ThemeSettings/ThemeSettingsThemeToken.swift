        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-settings.token.bold", defaultValue: "Bold", comment: "Help text for bold toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-settings.token.italic", defaultValue: "Italic", comment: "Help text for italic toggle"))
                }
