    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extensions.detail.features-section", defaultValue: "Features", comment: "Section header for extension features")) {
            ...
            Text(String(localized: "extensions.detail.settings-header", defaultValue: "Extension Settings", comment: "Header for extension settings section"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
